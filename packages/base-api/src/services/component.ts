import {
  type ComponentClientOptionsById,
  type ComponentDataResolverArgs,
  type ComponentId,
  type ComponentInDataById,
  type ComponentOptionsById,
  type ComponentOutDataById,
  type ComponentPartialInDataById,
  type ComponentResolvedDataById,
  type ComponentSearchIndexDataById,
  type ComponentStorageDataById,
  type ForeignComponentAtomWalkerContext,
  type ForeignComponentClientOptionsTransformerContext,
  type ForeignComponentDataMergeContext,
  type ForeignComponentDataMigrationContext,
  type ForeignComponentDataResolverContext,
  type ForeignComponentDataSearchContext,
