...
import { classNames, namedLazy, useModal } from '@game-cms/ui';
import { useCallback, useEffect, useState } from 'react';

import { useEntityChecksAllowed } from '../../../hooks/internal/useEntityChecksAllowed.js';
import {
  EntityComposeError,
...
const EntityCheckDocumentRunsModal = namedLazy(
  () => import('../../Entity/EntityCheckDocumentRunsModal/index.js'),
  'EntityCheckDocumentRunsModal'
);
...
export function AccessEntityView<Id extends EntityId>({
  ...
  const onShowEntityCheckRuns = useCallback(() => {
    if (initialId !== undefined) {
      void showModal(EntityCheckDocumentRunsModal, {
        entityId,
        documentId: initialId,
      });
    }
  }, [entityId, initialId, showModal]);
  ...
  return (
    <div className={classNames(styles.root, className)}>
      <Header
        ...
        onShowEntityCheckRuns={onShowEntityCheckRuns}
